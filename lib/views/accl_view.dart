...
class AcclView extends StatefulWidget {
  const AcclView({super.key});

  @override
  _AcclViewState createState() => _AcclViewState();
}

class _AcclViewState extends State<AcclView> {
  // GUI Fields & Parameters
  late AcclViewModel _viewModel;
  Timer? _timer;

  @override
  void initState() {
    super.initState();
    _viewModel = AcclViewModel();
