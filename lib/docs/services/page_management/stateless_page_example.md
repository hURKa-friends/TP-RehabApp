...
# Example of "Creating your own StatelessPage"
`StatelessPage` is abstract class which needs to be extended by your own View class. Your 
`foo_view.dart` should look like this:
```dart
import 'package:flutter/material.dart';
import 'package:rehab_app/services/page_management/premenne/stateful_page_model.dart';
...
import 'package:rehab_app/view_models_rehab/menu_view_model.dart';
///
/// Import your MVVM ViewModels here
///
import 'package:rehab_app/view_models_rehab/accl_viewmodel.dart';
import 'package:rehab_app/view_models_rehab/gyro_viewmodel.dart';
import 'package:rehab_app/view_models_rehab/lux_viewmodel.dart';
import 'package:rehab_app/view_models_rehab/mag_viewmodel.dart';
import 'package:rehab_app/view_models_rehab/settings_view_model.dart';
